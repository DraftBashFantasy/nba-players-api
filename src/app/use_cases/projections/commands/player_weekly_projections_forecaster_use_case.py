...
from interfaces.projections_model import IPlayerWeeklyProjectionsForecasterService
from domain.entities import ProjectionEntity, PlayerEntity, GamelogEntity, ScheduledMatchupEntity
...
class PlayerWeeklyProjectionsForecasterUseCase:
    ...
    def execute(self) -> None:
        ...
        gamelogs: list[GamelogEntity] = self._gamelog_repository.get_all()

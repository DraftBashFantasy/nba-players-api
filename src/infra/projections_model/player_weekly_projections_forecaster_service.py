...
class PlayerWeeklyProjectionsForecasterService(IPlayerWeeklyProjectionsForecasterService):
    ...
    def _calculate_projections(self, player_averages: pd.Series, defense_ratings: pd.Series) -> dict[float]:
        """
        Uses player averages and defense ratings to calculate player statistics with
        multivariate linear regressions trained through machine learning.
        
        :param player_averages: A pandas series of player averages.
        :param defense_ratings: A pandas series of defense ratings.
        :return: A dictionary of player projections.
        :rtype: dict
        """
